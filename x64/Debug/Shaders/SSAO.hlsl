...
void CS(uint3 id : SV_DispatchThreadID)
{
    ...
    SsaoOutput[id.xy] = float4(pz, pz, pz, 1.0f);
    ...
    float2 noiseScale = float2(SsaoMapWidth / NoiseMapWidth, SsaoMapHeight / NoiseMapHeight);
    ...
    float dynamicRadius = max(0.1f, gOcclusionRadius * (posV.z / 0.05f));
    ...
    SsaoOutput[id.xy] = float4(posV.r, 0.0f ,0.0f, 1.0f);
}